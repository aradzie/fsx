...
export const cp = util.promisify(fs.cp); // eslint-disable-line n/no-unsupported-features/node-builtins
export const cpSync = fs.cpSync; // eslint-disable-line n/no-unsupported-features/node-builtins
export const exists = util.promisify(fs.exists); // eslint-disable-line n/no-deprecated-api
...
export const lutimes = util.promisify(fs.lutimes);
...
export const readv = util.promisify(fs.readv);
